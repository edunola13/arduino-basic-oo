 ...
 *  
 *  Note: La idea es parsiar solo un nivel de objetos (no se armar estructuras de arbol), tal vez para pasar a json si se pueda pero para parsear no esta contemplado.
